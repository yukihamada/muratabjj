            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-lg bg-white/10 border border-white/10 focus:border-bjj-accent focus:outline-none"
                />
              </div>
              ...
              <select
                ...
                className="px-4 py-2 rounded-lg bg-white/10 border border-white/10 focus:border-bjj-accent focus:outline-none"
              >
